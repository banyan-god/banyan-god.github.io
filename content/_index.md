...
- Gained foundational knowledge from resources like Karpathy’s tutorials and Danielle Bourke’s "Learn PyTorch for Deep Learning in a Day," progressing from basic neural networks to implementing NanoGPT models.
...
- **DevOps & Tools:** Git, Jenkins, Maven, Gradle, Docker, Kubernetes, Terraform, JIRA, Asana
...
- **Machine Learning:** Python, TensorFlow, Scikit-learn, Data Analysis, Model Deployment
